...
final class locallib_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $this->book = $this->getDataGenerator()->create_module('book', array('course' => $course->id));
    ...
    public function test_import_chapters_events(): void {
        ...
        $file = get_file_storage()->create_file_from_pathname($this->record, self::get_fixture_path(__NAMESPACE__, 'chapters.zip'));
    ...
    public function test_import_chapters_links(): void {
        ...
        $file = get_file_storage()->create_file_from_pathname($this->record, self::get_fixture_path(__NAMESPACE__, 'chapters_links.zip'));
